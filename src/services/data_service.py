...
class DataService:
    ...
    def get_price_data(self, ticker: str) -> pd.DataFrame:
        """Load full OHLCV data for a single ticker.

        Args:
            ticker: Ticker symbol.

        Returns:
            DataFrame with DatetimeIndex and OHLCV columns, or empty
            DataFrame if not available.  Column names are lower-cased
