...
# ─────────────────────────────────────────────
# Production UI (HTMX + Jinja2)
# ─────────────────────────────────────────────

from pathlib import Path as _Path

_web_static = _Path(__file__).resolve().parent.parent.parent / "web" / "static"
app.mount("/static", StaticFiles(directory=str(_web_static)), name="static")

from web.routes.ui import router as ui_router  # noqa: E402
from web.routes.watchlist import router as watchlist_router  # noqa: E402
from web.routes.chart import router as chart_router  # noqa: E402
from web.routes.dca_chat import router as dca_chat_router  # noqa: E402
from web.routes.news import router as news_router  # noqa: E402
from web.routes.guide_chat import router as guide_chat_router  # noqa: E402
from web.routes.analyse import router as analyse_router  # noqa: E402
from web.routes.portfolio import router as portfolio_router  # noqa: E402
from web.routes.execute import router as execute_router  # noqa: E402
from web.routes.personas import router as personas_router  # noqa: E402
from web.routes.deployment import router as deployment_router  # noqa: E402

app.include_router(ui_router)
app.include_router(watchlist_router)
app.include_router(chart_router)
app.include_router(dca_chat_router)
...
def health() -> dict:
    ...
    services = {
        ...
        "strategy_service": "available",
        "execution_service": "available",
        "alert_delivery_service": "available",
        "market_data_service": "available",
        "dca_service": "available",
        "monte_carlo_service": "available",
