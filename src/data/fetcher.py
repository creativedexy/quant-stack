...
class YFinanceFetcher(DataFetcher):
    ...
    def __init__(self, **kwargs: Any) -> None:
        # Accept and ignore kwargs (e.g. seed) for factory compatibility.
        pass
    ...
    def fetch_multiple(
        ...
        for ticker in tickers:
            try:
                # yfinance v2+ always returns MultiIndex (ticker, field) columns
                df = raw[ticker][ohlcv].copy()
                df.columns = ohlcv  # flatten from MultiIndex to plain strings
